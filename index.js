...
const memes = ['https://cdn.glitch.com/6bc96be7-1015-4474-82ab-c330b47f2b5e%2FJessica.PNG?1535893024570',
               'https://cdn.glitch.com/6bc96be7-1015-4474-82ab-c330b47f2b5e%2Fimage.png?1538485187865',
               'https://cdn.glitch.com/6bc96be7-1015-4474-82ab-c330b47f2b5e%2Fimage.png?1538485152879',
               'https://cdn.glitch.com/6bc96be7-1015-4474-82ab-c330b47f2b5e%2Fimage.png?1538485231687',
              ]
...
client.on('message', message => {
  ...
  if (message.content.startsWith('Meme please!')) {
     message.reply(memes[_.random(0, memes.length - 1)]);
  }
});
